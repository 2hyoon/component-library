...
export default class Flip2 {
  ...
  init() {
    ...
    function start() {
      ...
      const texture2 = new THREE.TextureLoader().load( 'assets/img/pic/unsplash-02.jpg' );
      texture2.center.set(0.5, 0.5);
      texture2.repeat.set(0.005, 0.005);

      // const videoTexture = new THREE.TextureLoader().load( 'assets/video/FinSci_Desktop2X.mp4' );
      // videoTexture.center.set(0.5, 0.5);
      // videoTexture.repeat.set(0.005, 0.005);

      // const video = document.getElementById( 'video' );
      // const videoTexture = new THREE.VideoTexture( video );
      // videoTexture.center.set(0.5, 0.4);
      // videoTexture.repeat.set(0.005, 0.005);
      ...
      materials = [
        new THREE.MeshBasicMaterial({ color: 0xffffff, map: texture}), // front
        new THREE.MeshBasicMaterial({ color: 0xdddddd }), // side
      ];

      materialsBack = [
        new THREE.MeshBasicMaterial({ color: 0xffffff, map: videoTexture}), // front
        new THREE.MeshBasicMaterial({ color: 0xdddddd }), // side
      ]
